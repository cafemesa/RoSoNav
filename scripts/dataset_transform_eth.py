...
init_frames = [824, 2199, 4249, 6299, 7299, 7749, 8400, 9624, 10324, 10625]
end_frames = [1026, 2399, 4449, 6474, 7449, 7899, 8499, 9724, 10499, 10950]
hidden_agent_ids = [7, 48, 77, 124, 150, 159, 189, 226, 273, 303, 304]
...
if __name__ == "__main__":
    ...
    for scene_index, (init_frame, end_frame) in enumerate(zip(init_frames, end_frames)):
        ...
        for agent_ids in agents_in_scene:
            if agent_ids==171 or agent_ids==216 or agent_ids==238:
                continue
