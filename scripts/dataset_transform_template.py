...
#############################################################################################
########################## Fill this variables to add new datasets ##########################
#############################################################################################
...
init_frames = [0, 1000, 2000, 3000, 4000, 5200, 6300, 7000, 9200, 10000, 11000, 12400, 13000, 14200, 15000]
end_frames = [800, 1800, 2800, 3800, 4800, 6000, 7000, 7800, 10000, 10800, 11800, 13000, 13800, 15000, 15800]
...
if __name__ == "__main__":
    ...
    for index in obstacles_indices:
        ...
        point_in_meters[0]+= 0
        point_in_meters[1]+= 0
        x_pixels = int((origin[0] - point_in_meters[0]) / resolution)
        y_pixels = int((origin[1] - point_in_meters[1]) / resolution)
